...
require (
	...
	github.com/docker/docker v24.0.5-0.20230718221249-d4a26c153000+incompatible // indirect
...
replace (
	...
	knative.dev/func v1.11.0 => github.com/knative/func v0.38.1-0.20230727133609-0d6e21067380
)
